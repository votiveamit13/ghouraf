    ...
    <div className="relative bg-white p-4 rounded-[12px] shadow-xl border border-[#D7D7D7] flex flex-col md:flex-row gap-4 mb-4">
      ...
      <div className="flex flex-col flex-grow">
        <Link to={`/team-up/${property._id}`}>
          <h3 className="font-semibold text-[20px] text-black">
            {property.title} in {locationString}
          </h3>
        </Link>

        <p className="text-[15px] mt-1 text-black">{property.description}</p>
      ...
      <div className="flex flex-col justify-between items-end">
        <span className="font-bold text-lg text-black">
          ${property.budget} / {property.budgetType?.toLowerCase()}
        </span>
        ...
        <div className="flex flex-row lg:flex-col gap-2 font-bold">
          ...
          <button
            ...
            className="border border-[#565ABF] text-[#565ABF] px-3 py-2 rounded-[4px] text-sm flex gap-2 items-center"
          >
