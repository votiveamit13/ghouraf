                  ...
                  <div className="mb-4">
                    ...
                    <div className="d-flex flex-wrap gap-3">
                      {[
                        ...
                        <div key={item} className="form-check d-flex align-items-center gap-2">
                          <input
                            type="checkbox"
                ...
                {step === 3 ? (
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-3">
                      ...
                      <button className="px-4 py-3 rounded-[6px] bg-[#565ABF] text-white hover:opacity-95 flex items-center gap-2 font-semibold" onClick={() => setPreviewMode(true)}>
