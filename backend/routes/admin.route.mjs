...
router.get("/", adminAuth, getPromotionOptions);
router.post("/", adminAuth, addPromotionOption);
router.patch("/:id", adminAuth, updatePromotionOption);
router.delete("/:id", adminAuth, deletePromotionOption);
